...
data_set = read.csv('F:/WORK/rWork/rProjects/Analytics_Edge/Analytics_Edge_R/data/HR_Data.csv')
View(data_set)
...
table(testData$left)
#Since, the value at quantile level at 76% is 0.40,
#Hence, we consider all the values greater than this value as 1 and others as 0 in our Predicted values column.
testData$Pred_Attrition <- ifelse(testData$Pred_Attrition > 0.42,1,0)
View(testData)
