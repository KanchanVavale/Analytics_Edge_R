...
barplot(table(mtcars$gear),col=1:3, main='No of cars of each gear type', xlab='Gear Type', ylab='Count of Cars')
...
plot(x=X, y=Y, type='p', pch=5) #points, plotting symbol=13
